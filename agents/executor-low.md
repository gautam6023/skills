---
name: executor-low
description: Implementation executor (low effort) for orchestrated work. Writes and edits code, runs builds and tests. Model is chosen by the orchestrator at spawn time via the model parameter. Use for any task that changes files.
effort: low
---
